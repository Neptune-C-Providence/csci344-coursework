...
@app.route('/message')
def exercise1():
     return f"Hi {current_user["first_name"]} {current_user["last_name"]}! Also VSCode, could you please stop throwing a fit"
...
def exercise3():
    ...
    if not search_term or not location:
        return "Search term and location are required"
    count = 10
